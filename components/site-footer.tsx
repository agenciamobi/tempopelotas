...
export function SiteFooter({ source }: SiteFooterProps) {
  ...
  const primarySources = [source.observationName, source.forecastName]
    ...
    .map((item) => item.trim());
  const activeSources = Array.from(new Set(primarySources.length ? primarySources : [source.name])).slice(0, 3);
      ...
      <div className="editorial-footer">
        ...
        <section className="editorial-footer__lead" aria-labelledby="editorial-footer-title">
          <div className="editorial-footer__lead-copy">
            ...
            <p>
              Previsão, medições, avisos oficiais e situação das águas reunidos em um
              único portal.
            </p>
          </div>
        ...
        <section className="editorial-footer__transparency" aria-label="Fontes e orientação de segurança">
          ...
          <div className="editorial-footer__guidance">
            ...
            <p>
              Em situações de risco, siga os comunicados da Defesa Civil, do INMET e
